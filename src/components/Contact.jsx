...
const Contact = () => {
  return (
    <div name="contact" className="w-full h-screen bg-gradient-to-b from-blue-600 via-blue-700 to-blue-900  p-4 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/94770f33-2cf2-411e-8c9f-bd1a03122049" method= "POST" className="flex flex-col w-full md:w-1/2">
                    ...
                    <button className="text-white bg-black px-6 py-3 my-8 mx-auto
